...
const CONTENTS_PATH = ENV === 'prod' ? 'learn-webgl/' : '';

const SRC = `${ROOT}/src/`;
const DEST = ENV === 'prod' ? `${ROOT}/docs/` : `${ROOT}/dist/`;
...
const paths = {
  ...
  script: {
    ...
    libs: [
      ...
      `${ROOT}/node_modules/tweakpane/dist/tweakpane.min.js`,
...
const constants = {
  ...
  prod: {
    url: `https://ohagip.github.io/${CONTENTS_PATH}`,
    contentsPath: `/${CONTENTS_PATH}`,
    assetsPath: `/${CONTENTS_PATH}assets/`,
  },
};
